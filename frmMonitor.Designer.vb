...
Partial Class frmMonitor
    ...
    Private Sub InitializeComponent()
        ...
        Dim TreeNode1 As System.Windows.Forms.TreeNode = New System.Windows.Forms.TreeNode("Mimics unit not broadcasting")
        Dim TreeNode2 As System.Windows.Forms.TreeNode = New System.Windows.Forms.TreeNode("Mimics unit connected ")
        Dim TreeNode3 As System.Windows.Forms.TreeNode = New System.Windows.Forms.TreeNode("Mimics unit connected - notifications", 2, 2)
        Dim TreeNode4 As System.Windows.Forms.TreeNode = New System.Windows.Forms.TreeNode("Mimics unit connected > 3 mins ago")
        ...
        TreeNode1.SelectedImageKey = "explorer_exe_Ico62_ico_Ico1.ico"
        TreeNode1.Text = "Mimics unit not broadcasting"
        TreeNode2.ForeColor = System.Drawing.Color.FromArgb(CType(CType(0, Byte), Integer), CType(CType(192, Byte), Integer), CType(CType(0, Byte), Integer))
        TreeNode2.ImageKey = "check.png"
        TreeNode2.Name = "Node1"
        TreeNode2.SelectedImageKey = "check.png"
        TreeNode2.Text = "Mimics unit connected "
        TreeNode3.ForeColor = System.Drawing.Color.FromArgb(CType(CType(255, Byte), Integer), CType(CType(128, Byte), Integer), CType(CType(0, Byte), Integer))
        TreeNode3.ImageIndex = 2
        TreeNode3.Name = "Node2"
        TreeNode3.SelectedImageIndex = 2
        TreeNode3.Text = "Mimics unit connected - notifications"
        TreeNode4.ForeColor = System.Drawing.Color.DarkSeaGreen
        TreeNode4.ImageKey = "check_in.png"
        TreeNode4.Name = "Node0"
        TreeNode4.SelectedImageKey = "check_in.png"
        TreeNode4.Text = "Mimics unit connected > 3 mins ago"
        Me.TreeViewKey.Nodes.AddRange(New System.Windows.Forms.TreeNode() {TreeNode1, TreeNode2, TreeNode3, TreeNode4})
